	...
	private: System::Void button1_Click(System::Object *  sender, System::EventArgs *  e)
			 {
				...
				Interop::WComm_Serial::IWComm_Serial		*wserial;				//创建通信COM对象
				WComm_UDP::IWCOMM_OPERATE		*wudp ;				//UDP通信对象
				...
				while (true)
				{
					...
					controllerSN = System::Convert::ToInt64 (this->textBoxSN->Text) ;  //测试使用的控制器
					strComPort = this->TextBoxSerailPort->Text;               //使用的通信端口

					strInfo = String::Concat("控制器通信－" , controllerSN.ToString() , "-", strComPort);
					...
					strFrame = wserial ->serial_comm(strCmd, strComPort);	//发送指令, 并获取返回信息
