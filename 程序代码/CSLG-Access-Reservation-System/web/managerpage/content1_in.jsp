...
<div class="container-fluid">
    ...
    <div class="col-lg-8 col-md-9  top_right clearfix">
        ...
        <div class="col-sm-6">
            ...
            <h3><span class="col-sm-4">学/工号</span><input id="identity_number"type="text"></h3>
        ...
        <h3 class='col-xs-12' style="line-height: 5;text-align: center"><a href="javascript:;" id="saveChanges" class="btn btn-default">保存修改</a></h3>
    </div>
</div>
</body>
...
<script type="text/javascript">
    ...
    var password,wechat_id ,phone_number,identity_number;
    var time=3;
    ...
    function updateUser(){
         ...
         xmlhttp.open("GET","UpdateUserServlet?flag=updateUser_manager&user_id="+request("user_id")+"&wechat_id="+wechat_id+"&phone_number="+phone_number+"&identity_number="+identity_number+"&password="+password+"&information="+document.getElementById("information").value,true);
         xmlhttp.send();
