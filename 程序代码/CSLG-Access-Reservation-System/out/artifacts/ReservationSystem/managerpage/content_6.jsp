...
<head>
    ...
    <style>
        ...
        .top_left{background: #d5a380;height: 500px;}
        .top_right{background: #a27150;min-height: 500px;}
        ...
        .content_box{margin-top: 22%;color: #fff}
        .box{margin: 5% auto;}
...
<div class="container-fluid">
    <div class="col-lg-4 col-md-3  top_left ">
        <h1>设备管理</h1>
        <a href="./content6_addactivityroom.jsp" class="btn-default btn">添加</a>
    </div>
    <div class="col-lg-8 col-md-9  top_right clearfix">
        ...
        <div  id="div_roomList"class="row col-xs-12">
    ...
    <div class="col-xs-12 header">
        <div style="width: 0;height: 0;position: relative;left: 70%;border-left: 25px solid transparent;border-right: 25px solid transparent;border-top: 35px solid #a27150;"></div>
        ...
        <div class="col-xs-1"></div>
        <a href="javascript:;" class="col-xs-2 text-center" style="background: #a27150">
            <span>设备管理</span>
        </a>
        <div class="col-xs-1"></div>
...
function gotoPageNum(pagenum){
   ...
   pageNum=pagenum;
    ...
    function dynamicCreate(){
        ...
        var k;
            ...
            for(var i=start;i<end;i++,j++){
               ...
               h+='<a href="./content6_in.jsp?room_id='+array[i].room_id+'&room_name='+array[i].room_name+'"class="row col-sm-6 col-xs-12 center-block">';
               h+='<img class="col-sm-6 col-xs-7" src="./img/content1.png" alt="">';
               h+='<div class="col-sm-6 col-xs-10 content_box">';
                   h+='<p>'+array[i].room_name+'</p>';
                   h+='<p>活动室位置'+array[i].information+'</p>';
                   h+='</div>';
               h+='</a>';
               if(j==1){
                   h+='</div>';
           ...
           li+='</ul>'
            pageNum++;
            start=i;   
        $('#div_roomList').append(h); 
        $('#li_prev').after(li); 
        
    }
    function mouseDown(room_id,room_name){
        alert(room_id);
        alert(room_name);
        //location.href='content6_in.jsp?room_id='+room_id+'&room_name='+room_name;
    }
    ...
    function init(){
     ...
     xmlhttp.open("GET","QueryAllActivityRoomServlet?flag=query_allActivityRoom_manager",true);
     xmlhttp.send();
     xmlhttp.onreadystatechange=function() {
         if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
             ...
             if(array.length==0){
                 var h='';
                 h += '<h3 style="color:red" align="center">'+ "暂未有任何活动室！"+'</h3>';
                 $('#div_roomList').append(h); 
                 $("#div_button").remove();
             }else{
